...
@Component
internal class PutOptionPriceCalculator : SecurityPriceCalculator {
    ...
    override fun calculate(security: Security, price: BigDecimal): BigDecimal {
        ...
        return BigDecimal.valueOf(
            BlackScholesUtil.calculatePutOptionPrice(
                price.toDouble(), security.strike!!.toDouble(), years
            )
        ).setScale(2, RoundingMode.HALF_UP)
    }

    override fun getSecurityType(): SecurityType = SecurityType.PUT
}
